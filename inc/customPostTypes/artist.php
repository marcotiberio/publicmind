...
function registerArtistPostType()
{
    $labels = [
        'name'                  => _x('Artists', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Artist', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Artists', 'flynt'),
        'name_admin_bar'        => __('Artist', 'flynt'),
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerArtistPostType');
